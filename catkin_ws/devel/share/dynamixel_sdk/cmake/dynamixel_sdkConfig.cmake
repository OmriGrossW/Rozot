...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_sdk_SOURCE_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/src/robotican/dynamixel_sdk)
  set(dynamixel_sdk_DEVEL_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/devel)
  ...
  set(dynamixel_sdk_INSTALL_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/install)
...
if(NOT "/users/studs/bsc/2016/sdanie/catkin_ws/src/robotican/dynamixel_sdk/include " STREQUAL " ")
  set(dynamixel_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/users/studs/bsc/2016/sdanie/catkin_ws/src/robotican/dynamixel_sdk/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/users/studs/bsc/2016/sdanie/catkin_ws/src/robotican/dynamixel_sdk/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dynamixel_sdk_dep}_FOUND)
      find_package(${dynamixel_sdk_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dynamixel_sdk_dep} REQUIRED ${depend_list})
  endif()
