...
if("FALSE" STREQUAL "TRUE")
  set(dynamixel_msgs_SOURCE_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/src/dynamixel_motor/dynamixel_msgs)
  set(dynamixel_msgs_DEVEL_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/devel)
  ...
  set(dynamixel_msgs_INSTALL_PREFIX /users/studs/bsc/2016/sdanie/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Antons Rebguns <arebgun@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/users/studs/bsc/2016/sdanie/catkin_ws/install/${idir}'.  Ask the maintainer 'Antons Rebguns <arebgun@gmail.com>' to fix it.")
    endif()
...
set(dynamixel_msgs_EXPORTED_TARGETS "dynamixel_msgs_generate_messages_cpp;dynamixel_msgs_generate_messages_lisp;dynamixel_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dynamixel_msgs_dep}_FOUND)
      find_package(${dynamixel_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dynamixel_msgs_dep} REQUIRED ${depend_list})
  endif()
