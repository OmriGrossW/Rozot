...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotican_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/users/studs/bsc/2016/sdanie/catkin_ws/install/${idir}'.  Ask the maintainer 'tom <tom@todo.todo>' to fix it.")
    endif()
